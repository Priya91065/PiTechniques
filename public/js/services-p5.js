...
const IMG_PATH =
  ...
  (isMobileView
    ? 'images/banner-img/services-mobile.jpg'   // 👈 mobile image
    : 'images/banner-img/services-animation-banner.jpg');        // 👈 desktop image
  ...
  const FRAME_RATE = 30;
  const BRIGHTNESS_THRESHOLD = 35; // skip dark/black pixels (0–255)
  // -----------------------
