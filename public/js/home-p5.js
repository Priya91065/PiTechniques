...
const IMG_PATH =
  ...
  (isMobileView
    ? 'images/banner-img/homepage-animation-banner.jpg'   // 👈 mobile image
    : 'images/banner-img/homepage-animation-banner.jpg');        // 👈 desktop image
  ...
  function buildDots() {
    ...
    const ratio = sampleW / img.width;
    const sampleH = Math.round(img.height * ratio);
