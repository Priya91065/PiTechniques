/**
 * Job openings — faithful copy of data.json from the PHP site. Used by the
 * careers list and the career-details page. `responsibilities` is either a flat
 * string[] or a category→tasks map, exactly as the original PHP handled.
 */
export interface FaithfulJob {
  slug: string;
  title: string;
  experience: string;
  jobcode: string;
...
export const faithfulJobs: FaithfulJob[] = [
  {
