...
import { discardDraft } from "@/server/services/homepageStaging";
...
export async function POST(): Promise<NextResponse> {
  ...
  try {
    ...
    await prisma.activityLog.create({
      data: { userId: g.user.sub, action: "UPDATE", entityType: "Homepage", entityId: "home", summary: "Discarded homepage draft changes" },
    });
